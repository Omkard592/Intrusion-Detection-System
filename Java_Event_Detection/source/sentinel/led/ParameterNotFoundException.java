...
/** ParameterNotFoundException is thrown when the application tries to retrieve the
 *  value of an event parameter from the ParameterList. The exception is thrown
 *  if the parameter with the given name is not present in the ParameterList.
 */

public class ParameterNotFoundException extends Exception {

   public ParameterNotFoundException(String varName) {

      super("\n\n Variable \"" + varName +
		"\" not found in the ParameterList");
   }
}
