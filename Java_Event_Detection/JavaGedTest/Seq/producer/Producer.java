...
public class Producer implements Serializable {
  ...
  public static void main(String[] args) {
    ...
    EventHandle startOrstop =     myAgent.createCompositeEvent (EventType.OR,"startOrstop",startServiceEvent,stopServiceEvent);

    EventHandle startSeqstop =     myAgent.createCompositeEvent (EventType.SEQ,"startSeqstop",startServiceEvent,stopServiceEvent);
